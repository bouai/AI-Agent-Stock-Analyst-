...
# Get user input for the stock symbol or company name
stock_query = input("Enter the company name or stock symbol: ")

# Generate the query string
query = f"Summarize analyst recommendations and share the latest news for {stock_query}."

# Pass the query to the multi-agent for analysis
